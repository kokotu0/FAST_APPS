...
Revision ID: 9d22cdb0affa
Revises: 03eb13fa2197
Create Date: 2025-11-27 12:18:52.540291
...
revision = '9d22cdb0affa'
down_revision = '03eb13fa2197'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_foreign_key(None, 'item', 'user', ['owner_id'], ['idx'], ondelete='CASCADE')
